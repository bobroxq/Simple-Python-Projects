...
def random_fifty_shades():
    word_1 = random.choice(verbs_s)
    word_2 = random.choice(body_parts)
    word_3 = random.choice(body_parts)
    word_4 = random.choice(body_parts)
    word_5 = random.choice(verbs_s)
    word_6 = random.choice(body_parts)
    word_7 = random.choice(body_parts)
    word_8 = random.choice(verbs_s)
    word_9 = random.choice(adjectives)
    word_10 = random.choice(adjectives)
    word_11 = random.choice(body_parts)
    word_12 = random.choice(body_parts)
    word_13 = random.choice(body_parts)
    word_14 = random.choice(body_parts)
    word_15 = str(input('Enter your name: '))
    word_16 = random.choice(verbs_s)
    word_17 = random.choice(nouns_single)
    word_18 = random.choice(body_parts)
    word_19 = random.choice(nouns_single)
    word_20 = random.choice(body_parts)
    word_21 = random.choice(body_parts)
    word_22 = random.choice(body_parts)
    word_23 = random.choice(adverbs)
    word_24 = random.choice(adjectives)
    word_25 = random.choice(nouns_single)
    word_26 = str(input("Enter someone's name: "))
    word_27 = random.choice(adjectives)
    word_28 = random.choice(adjectives)
    word_29 = random.choice(verbs_ing)
...
def random_awkward_encounter():
    word_1 = random.choice(verbs_ing)
    word_2 = random.choice(liquids)
    word_3 = random.choice(foods)
    word_4 = random.choice(adjectives)
    word_5 = random.choice(nouns_single)
    word_6 = random.choice(adverbs)
    word_7 = random.choice(nouns_single)
    word_8 = random.choice(adjectives)
    word_9 = random.choice(verbs)
    word_10 = random.choice(adverbs)
    word_11 = random.choice(nouns_plural)
    word_12 = random.choice(nouns_plural)
    word_13 = random.choice(body_parts)
    word_14 = random.choice(nouns_plural)
    word_15 = random.choice(adjectives)
    word_16 = str(input("Enter some one's name: "))
    word_17 = random.choice(exclamtions)
    word_18 = random.choice(places)
...
def random_asking_out():
    word_1 = str(input('Enter a term of endearment: '))
    word_2 = str(input('Enter a first name: '))
    word_3 = str(input('Enter a last name: '))
    word_4 = random.choice(places)
    word_5 = random.choice(unit_of_time)
    word_6 = random.choice(adjectives)
    word_7 = random.choice(colors)
    word_8 = random.choice(clothing)
    word_9 = random.randint(1, 1000)
    word_10 = random.choice(verbs)
    word_11 = random.choice(verbs)
    word_12 = random.choice(verbs)
    word_13 = random.choice(verbs)
...
def random_restroom_recon():
    word_1 = random.choice(adjectives)
    word_2 = random.choice(adverbs)
    word_3 = random.choice(nouns_single)
    word_4 = random.choice(adverbs)
    word_5 = random.choice(adjectives)
    word_6 = random.choice(places)
    word_7 = random.choice(nouns_single)
    word_8 = random.choice(body_parts)
    word_9 = random.choice(adjectives)
    word_10 = random.choice(nouns_single)
    word_11 = random.choice(adjectives)
    word_12 = random.randint(1, 1000)
    word_13 = random.choice(adverbs)
    word_14 = random.choice(adjectives)
    word_15 = random.choice(nouns_single)
...
def random_job_interview():
    word_1 = random.choice(clothing)
    word_2 = str(input('Enter a superlative: '))
    word_3 = random.choice(nouns_plural)
    word_4 = random.choice(sports)
    word_5 = random.choice(nouns_single)
    word_6 = str(input('Enter a personal title: '))
    word_7 = random.choice(adverbs)
    word_8 = str(input('Enter an proper noun: '))
    word_9 = random.choice(song_titles)
    word_10 = random.choice(exclamtions)
    word_11 = random.choice(clothing)
    word_12 = random.choice(verbs)
    word_13 = str(input('Enter a name: '))
    word_14 = random.choice(nouns_plural)
    word_15 = random.choice(nouns_plural)
    word_16 = random.choice(clothing)
    word_17 = random.choice(adjectives)
    word_18 = random.choice(field_of_study)
...
def random_giraffe_facts():
    word_1 = random.choice(nouns_plural)
    word_2 = random.choice(nouns_plural)
    word_3 = random.choice(body_parts)
    word_4 = random.randint(1, 1000)
    word_5 = random.choice(nouns_plural)
    word_6 = random.choice(body_parts)
    word_7 = random.choice(liquids)
    word_8 = random.choice(body_parts)
    word_9 = random.choice(body_parts)
    word_10 = random.choice(adjectives)
    word_11 = random.choice(nouns_plural)
    word_12 = random.choice(adjectives)
    word_13 = random.choice(adjectives)
    word_14 = random.choice(verbs_ing)
    word_15 = random.choice(nouns_single)
    word_16 = random.choice(verbs)
    word_17 = random.choice(nouns_single)
